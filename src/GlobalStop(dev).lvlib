...
<Library LVVersion="13008000">
	...
	<Item Name="Normal" Type="Folder">
		<Item Name="CheckSet STOP.vi" Type="VI" URL="../CheckSet STOP.vi"/>
		<Item Name="GET STOP.vi" Type="VI" URL="../GET STOP.vi"/>
	</Item>
	<Item Name="WithError" Type="Folder">
		<Item Name="GET STOP(WithError).vi" Type="VI" URL="../GET STOP(WithError).vi"/>
		<Item Name="CheckSet STOP(WithError).vi" Type="VI" URL="../CheckSet STOP(WithError).vi"/>
	</Item>
	<Item Name="RESET STOP.vi" Type="VI" URL="../RESET STOP.vi"/>
	<Item Name="SET STOP.vi" Type="VI" URL="../SET STOP.vi"/>
	<Item Name="INIT STOP.vi" Type="VI" URL="../INIT STOP.vi"/>
</Library>
